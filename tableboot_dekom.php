...
<th><img style="width:15px;height:15px;" src="<?php echo $app;?>/img/nav.png"></th>
	...
	<tbody>
		<?php
			$no=1;
			$sql="select a.*,b.pengirim from tbl_sekertariat_disposisi a left join tbl_kode_pengirim b on a.pengirim=b.kode_pengirim where a.jns is not null order by a.id desc ";
