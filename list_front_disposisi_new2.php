...
<th style="text-align:center;" class="">Kepada</th>
...
<th style="text-align:center;" class="">Download</th>
	...
	?>
		...
		<tr>
			...
			<td ><?php if($rsg['status']=="1"){echo $rsg['dari'];}else{echo $rsg['ke'];}?></td>
			<td ><?php  if($rsg['status']=="1"){echo "<a href=''><img src='img/ceklis2.jpg' width='25' title='read'></a>";}else{ echo "</br>&nbsp"; if($rsg['tgl_baca']==""){echo "<img src='img/ceklis.jpg' width='20' title='unRead'>";}else{echo "<a href=''><img src='img/ceklis2.jpg' width='25' title='read'></a>";}  if($rsg['tgl_tindak_lanjut']==""){} }?></td>
