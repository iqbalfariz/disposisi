...
?>
<table class="table col-md-10" cellspacing='1' style="background-color:#eee;font-size:11px;font-weight:bold;">
	<tr>
	...
	<tr align="center">
		...
		<td style="background-color:#c7def1;"><input type='checkbox' value='SEKPER' id='sekper' name='ke[]'  class='css-checkbox lrg'/>
				<label for='sekper'  name='checkbox69_lbl' class='css-label lrg vlad'>&nbsp;&nbsp;SEKPER</label></td>
		<td></td>
		<td></td>
		<td></td>
		<td></td>
		<td  style="background-color:#c7def1;"><input type='checkbox' value='SPI' id='spi' name='ke[]'  class='css-checkbox lrg'/>
				<label for='spi'  name='checkbox69_lbl' class='css-label lrg vlad'>&nbsp;&nbsp;SPI</label>
		</td>
	</tr>
	<tr align="center">
		<td></td>
	...
	<tr align="center">
		...
		<td>
			<input type='checkbox'  id='algmd1' onclick='cekalldir1(this.id)'  class='css-checkbox lrg'/>
				<label for='algmd1'  name='checkbox69_lbl' class='css-label lrg vlad'>&nbsp;All</label>
		</td>
		<td >
			<input type='checkbox' value='' id='algmd2' onclick='cekalldir2(this.id)'  class='css-checkbox lrg'/>
				<label for='algmd2'  name='checkbox69_lbl' class='css-label lrg vlad'>&nbsp;All</label>
		</td>
		<td >
			<input type='checkbox' value='' id='algmd3'  onclick='cekalldir3(this.id)'  class='css-checkbox lrg'/>
				<label for='algmd3'  name='checkbox69_lbl' class='css-label lrg vlad'>&nbsp;All</label>
		</td>
		<td >
			<input type='checkbox' value='' id='algmd4'  onclick='cekalldir4(this.id)'  class='css-checkbox lrg'/>
				<label for='algmd4'  name='checkbox69_lbl' class='css-label lrg vlad'>&nbsp;All</label>
		</td>
		<td>
			<input type='checkbox' value='' id='algmd5' onclick='cekalldir5(this.id)'  class='css-checkbox lrg'/>
				<label for='algmd5'  name='checkbox69_lbl' class='css-label lrg vlad'>&nbsp;All</label>
		</td>
	</tr>
...
<tr align="center" >
	...
	<td style="border:solid 1px #000; background-color:#c7def1;" style="border:solid 1px #000;">DIV.PENGEMB. JALAN TOL & BISNIS</td>
...
<tr align="center">
	...
	<td style="border:solid 1px #000; background-color:#c7def1;;">DIV.PENGEMB. BISNIS KONSTRUKSI</td>
...
<tr align="center">
	 <td rowspan="8" style="border:solid 1px #000;  " ><input type='checkbox' value='' id='ap' onclick='cekallap(this.id)'   class='css-checkbox lrg'/>
