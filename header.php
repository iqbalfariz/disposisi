...
<img src="<?php echo $app;?>/img/monitor.png" width="25">
	<?php
		...
		$sqltotalnya="select count(status_srt) as totalnya from tbl_disposisi where status_srt='1' and ke='$_SESSION[uname]' and tgl_baca is null ";
		$sqleks=pg_query($sqltotalnya);
		$rtotal=pg_fetch_array($sqleks);
		
		
	?>
<span class="badge badge-neutral"><?php // echo $rtotal['totalnya'];?></span>
</a>
