		...
		if(!empty($_POST['status'])){
			if($_POST['status']=="1" &&!empty($_POST['ke'])&&!empty($_POST['dis'])){	
				...
				$eksupdate=pg_query($sqlupdatetindak);
					...
					$dari=$rdari['dari'];
					$simpannotif="insert into tbl_notif values(nextval('tbl_notif_id_seq'::regclass),'$_GET[id]','$dari','$_SESSION[uname]','$date','')";
...
?>
<table class="table col-md-10" style="background-color:#eee;font-size:11px;">
	<tr>
		<td width="10%">
		...
		<td style="background-color:#E2980D;">DIREKSI :</td>
		<?php
				$sql="select * from tbl_jabatan_login where kategori='1' and unit_kerja='KP' and kode_jabatan!='SP' and kode_jabatan!='SPI' and kode_jabatan!='SEKAR' order by id2 asc";
			...
			?>
				<td align="center" ><input type='checkbox' value='<?php echo $rd[kode_jabatan];?>' id='<?php echo $rd[kode_jabatan];?>' name='ke[]' onclick='tes(this)'  class='css-checkbox lrg'/>
				<label for='<?php echo $rd[kode_jabatan];?>'  name='checkbox69_lbl' class='css-label lrg vlad'></label></td>
			<?php
				}
			?>
		<td>
	...
	<tr>	
		...
		<?php
			...
			?>
				<td align="center"  style="background-color:#0DB0E2;align:center;"><?php echo $kode;?></br>(<?php echo $rd['kode_jabatan'];?>)</td>
			<?php
				}
			?>
	...
	<tr>
		<td width="5%">
				<input type='checkbox' value='gmkp' id='gmkp' name='gmkp' onclick='allgmkp(this.id)'  class='css-checkbox lrg'/>
				<label for='gmkp'  name='checkbox69_lbl' class='css-label lrg vlad'>All GM</label>
		</td>
		<td style="background-color:#E2980D;">GM KP :</td>
		<?php
				$sql="select * from tbl_jabatan_login where kategori='1' and unit_kerja='KP' and kode_jabatan!='SP' and kode_jabatan!='SPI' and kode_jabatan!='SEKAR' order by id2 asc";
				$eksql=pg_query($sql)or die($sql);
				while($rd=pg_fetch_array($eksql)){
			...
			?>
				<td ><input type='checkbox' value='<?php echo "all".$rd[kode_jabatan];?>' id='<?php echo "all".$rd[kode_jabatan];?>' name='ke[]' onclick='<?php echo "alld".$rd[id];?>(this.id)'  class='css-checkbox lrg'/>
				<label for='<?php echo "all".$rd[kode_jabatan];?>'  name='checkbox69_lbl' class='css-label lrg vlad'></label></td>
			<?php
				}
			?>
		<td>
	...
	<tr>	
		<td></td>
		<td>SEKPER</td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKPER' id='sekper' name='ke[]'  class='css-checkbox lrg'/>
				<label for='sekper'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKPER</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKPER' id='sekper1' name='ke[]'   class='css-checkbox lrg'/>
				<label for='sekper1'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKPER</lable></td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKPER' id='sekper2' name='ke[]'   class='css-checkbox lrg'/>
				<label for='sekper2'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKPER</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKPER' id='sekper3'  name='ke[]'   class='css-checkbox lrg'/>
				<label for='sekper3'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKPER</lable></td>
	</tr>
	<tr>	
		<td></td>
		<td>SPI</td>
		<td style="background-color:#999;"><input type='checkbox' value='SPI' id='sp' name='ke[]'   class='css-checkbox lrg'/>
				<label for='sp'  name='checkbox69_lbl' class='css-label lrg vlad'>SPI</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='SPI' id='sp1' name='ke[]'   class='css-checkbox lrg'/>
				<label for='sp1'  name='checkbox69_lbl' class='css-label lrg vlad'>SPI</lable></td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='SPI' id='sp2' name='ke[]'   class='css-checkbox lrg'/>
				<label for='sp2'  name='checkbox69_lbl' class='css-label lrg vlad'>SPI</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='SPI' id='sp3' name='ke[]'   class='css-checkbox lrg'/>
				<label for='sp3'  name='checkbox69_lbl' class='css-label lrg vlad'>SPI</lable></td>
	</tr>
	<tr>	
		<td></td>
		<td>Divisi Pemasaran</td>
		<td style="background-color:#999;"><input type='checkbox' value='GMMR' id='gmr' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmr'  name='checkbox69_lbl' class='css-label lrg vlad'>GMMR</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMMR' id='gmr1' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmr1'  name='checkbox69_lbl' class='css-label lrg vlad'>GMMR</lable></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>	
		<td></td>
		<td>Divisi Teknik & Produksi</td>
		<td style="background-color:#999;"><input type='checkbox' value='GMTP' id='gmtp' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmtp'  name='checkbox69_lbl' class='css-label lrg vlad'>GMTP</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMTP' id='gmtp1' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmtp1'  name='checkbox69_lbl' class='css-label lrg vlad'>GMTP</lable></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>	
		<td></td>
		<td>Divisi Pengembangan Bisnis</td>
		<td style="background-color:#999;"><input type='checkbox' value='GMPB' id='gmpb' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmpb'  name='checkbox69_lbl' class='css-label lrg vlad'>GMPB</lable></td>
		<td></td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr>	
		<td></td>
		<td>Divisi Pengambangan Jalan Tol</td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMPJT' id='gmpjt' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmpjt'  name='checkbox69_lbl' class='css-label lrg vlad'>GMPJT</lable></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	...
	<tr>	
		...
		<td></td>
		<td width="5%"></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMKU' id='gmku' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmku'  name='checkbox69_lbl' class='css-label lrg vlad'>GMKU</lable></td>
		<td></td>
	</tr>
	...
	<tr>	
		...
		<td></td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMAK' id='gmak' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmak'  name='checkbox69_lbl' class='css-label lrg vlad'>GMAK</lable></td>
		<td></td>
	</tr>
	<tr>	
		<td></td>
		...
		<td></td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMSU' id='gmsu' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmsu'  name='checkbox69_lbl' class='css-label lrg vlad'>GMSU</lable></td>
	</tr>
	<tr>	
		<td></td>
		<td>Divisi Sistem & Risiko</td>
		<td></td>
		<td ></td>
		<td></td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMSR' id='gmsr' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmsr'  name='checkbox69_lbl' class='css-label lrg vlad'>GMSR</lable></td>
	</tr>
	...
	<tr>
		<td width="12%">
				<input type='checkbox' value='wd' id='wd' name='wd' onclick='allwd(this.id)'  class='css-checkbox lrg'/>
				<label for='wd'  name='checkbox69_lbl' class='css-label lrg vlad'>All WIL/DIV</label>
		</td>
		<td style="background-color:#E2980D;">WIL / DIV :</td>
		<?php
			...
			?>
				<td ><input type='checkbox' value='<?php echo "allwil".$rd[kode_jabatan];?>' id='<?php echo "allwil".$rd[kode_jabatan];?>' onclick='<?php echo "allwil".$rd[id];?>(this.id)' name='ke[]'   class='css-checkbox lrg'/>
				<label for='<?php echo "allwil".$rd[kode_jabatan];?>'  name='checkbox69_lbl' class='css-label lrg vlad'></label></td>
			<?php
				}
			?>
		<td>
	...
	<tr>	
		<td></td>
		<td>Wilayah I</td>
		<td style="background-color:#999;"><input type='checkbox' value='GMW1' id='gmw1' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmw1'  name='checkbox69_lbl' class='css-label lrg vlad'>W I</lable></td>
		<td </td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr>	
		<td></td>
		<td>Wilayah II</td>
		<td style="background-color:#999;"><input type='checkbox' value='GMW2' id='gmw2' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmw2'  name='checkbox69_lbl' class='css-label lrg vlad'>W II</lable></td>
		<td ></td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr>	
		<td></td>
		<td>Divisi Gedung</td>
		<td style="background-color:#999;"><input type='checkbox' value='GMDG' id='gmdg' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmdg'  name='checkbox69_lbl' class='css-label lrg vlad'>DGD</lable></td>
		<td></td>
		<td></td>
		<td ></td>
		<td ></td>
	...
	<tr>	
		...
		<td>Wilayah III</td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMW3' id='gmw3' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmw3'  name='checkbox69_lbl' class='css-label lrg vlad'>W III</lable></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>	
		...
		<td>Wilayah IV</td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMW4' id='gmw4' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmw4'  name='checkbox69_lbl' class='css-label lrg vlad'>W IV</lable></td>
		<td></td>
		<td></td>
		<td ></td>
	</tr>
	<tr>	
		...
		<td>Wilayah V</td>
		<td ></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMW5' id='gmw5' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmw5'  name='checkbox69_lbl' class='css-label lrg vlad'>W V</lable></td>
		<td></td>
		<td ></td>
		<td></td>
	</tr>
	<tr>	
		<td></td>
		<td>Div.Jalan & Jembatan</td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMDJJ' id='gmdjj' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmdjj'  name='checkbox69_lbl' class='css-label lrg vlad'>DJJ</lable></td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>	
		...
		<td>Divisi EPC</td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='GMEPC' id='gmepc' name='ke[]'   class='css-checkbox lrg'/>
				<label for='gmepc'  name='checkbox69_lbl' class='css-label lrg vlad'>EPC</lable></td>
	...
	<tr>
		<td width="5%">
				<input type='checkbox' value='ap' id='ap' name='ap' onclick='allap(this.id)'   class='css-checkbox lrg'/>
				<label for='ap'  name='checkbox69_lbl' class='css-label lrg vlad'>All AP</label>
		</td>
		<td style="background-color:#E2980D;">ANAK PERUSAHAAN. :</td>
		<?php
				$sql="select * from tbl_jabatan_login where kategori='1' and unit_kerja='KP' and kode_jabatan!='SP' and kode_jabatan!='SPI' and kode_jabatan!='SEKAR' order by id asc";
				$eksql=pg_query($sql)or die($sql);
				while($rd=pg_fetch_array($eksql)){
			...
			?>
				<td ><input type='checkbox' value='<?php echo "ap".$rd[kode_jabatan];?>' id='<?php echo "ap".$rd[kode_jabatan];?>' onclick='<?php echo "ap".$rd[id];?>(this.id)' name='ke[]'   class='css-checkbox lrg'/>
				<label for='<?php echo "ap".$rd[kode_jabatan];?>'  name='checkbox69_lbl' class='css-label lrg vlad'></label></td>
			<?php
				}
			?>
		<td>
	...
	<tr>	
		...
		<td></td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='HKR' id='hr' name='ke[]'   class='css-checkbox lrg'/>
				<label for='hr'  name='checkbox69_lbl' class='css-label lrg vlad'>HKR</lable></td>
		<td></td>
	</tr>
	<tr>	
		<td></td>
		<td>HK Aston</td>
		<td style="background-color:#999;"><input type='checkbox' value='HKASTON' id='hk' name='ke[]'   class='css-checkbox lrg'/>
				<label for='hk'  name='checkbox69_lbl' class='css-label lrg vlad'>HKASTON</lable></td>
		<td></td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr>	
		<td></td>
		<td>HK Pole</td>
		<td style="background-color:#999;"><input type='checkbox' value='HKPOLE' id='hkp' name='ke[]'   class='css-checkbox lrg'/>
				<label for='hkp'  name='checkbox69_lbl' class='css-label lrg vlad'>HKPOLE</lable></td>
		<td ></td>
		<td></td>
		<td></td>
		<td></td>
...
<tr style="border-top:solid 2px #000;">
		<td width="5%">
				<input type='checkbox' value='sekar' id='sekar' name='sekar'  onclick='allsekar(this.id)'  class='css-checkbox lrg'/>
				<label for='sekar'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKAR</label>
		</td>

		<td style="background-color:#E2980D;">SEKAR</td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKAR' id='SEKAR2' name='ke[]'   class='css-checkbox lrg'/>
				<label for='SEKAR2'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKAR</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKAR' id='SEKAR3' name='ke[]'   class='css-checkbox lrg'/>
				<label for='SEKAR3'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKAR</lable></td>
		<td></td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKAR' id='SEKAR4' name='ke[]'   class='css-checkbox lrg'/>
				<label for='SEKAR4'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKAR</lable></td>
		<td style="background-color:#999;"><input type='checkbox' value='SEKAR' id='SEKAR5' name='ke[]'   class='css-checkbox lrg'/>
				<label for='SEKAR5'  name='checkbox69_lbl' class='css-label lrg vlad'>SEKAR</lable></td>	
</tr>
...
<ul style="list-style:none;">
	...
	<ul style="list-style:none;margin-left:10px;float:left;">
		<li>
			<?php
			...
			?>
				<input type='checkbox' value='<?php echo $rkp[kode_jabatan];?>' id='<?php echo $rkp[kode_jabatan]?>' name='ke[]'   class='css-checkbox lrg'/>
	...
	<ul style="list-style:none;margin-left:10px;float:left;">
		<li>
			...
			?>
					<input type='checkbox' value='<?php echo $rw[kode_jabatan];?>' id='<?php echo $rw[kode_jabatan];?>' name='ke[]'   class='css-checkbox lrg'/>
	...
	<ul style="list-style:none;margin-left:10px;float:left;">
		<li>
			...
			?>
					<input type='checkbox' value='<?php echo $rp[kode_jabatan];?>' id='<?php echo $rp[kode_jabatan];?>' name='ke[]'   class='css-checkbox lrg'/>
